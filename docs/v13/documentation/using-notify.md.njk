...
{{ govukDetails({
  ...
  html: "You can update to the <a href=\"https://prototype-kit.service.gov.uk/docs/update-to-latest-version\">latest version of the Prototype Kit</a> or in the terminal run:
